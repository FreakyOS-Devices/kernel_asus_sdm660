...
/************************** sysfs interface **************************/
static ssize_t show_sampling_rate_min(struct kobject *kobj, struct kobj_attribute *attr, char *buf)
{
...
static ssize_t show_profile(struct kobject *kobj, struct kobj_attribute *attr, char *buf)
{
...
static ssize_t store_sampling_down_max_momentum(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
...
static ssize_t store_sampling_down_momentum_sensitivity(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input, j;
	int ret;
	ret = sscanf(buf, "%u", &input);
 ...
 */
static ssize_t store_sampling_down_factor(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input, j;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_sampling_rate(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
 ...
 */
static ssize_t store_sampling_rate_idle(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_sampling_rate_idle_threshold(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_sampling_rate_idle_delay(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_disable_sleep_mode(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t store_sampling_rate_sleep_multiplier(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_up_threshold(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
#if (defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) && !defined(DISABLE_POWER_MANAGEMENT)) || defined(USE_LCD_NOTIFIER)
static ssize_t store_up_threshold_sleep(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_down_threshold(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
#if (defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) && !defined(DISABLE_POWER_MANAGEMENT)) || defined(USE_LCD_NOTIFIER)
static ssize_t store_down_threshold_sleep(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_ignore_nice_load(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t store_smooth_up(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
#if (defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) && !defined(DISABLE_POWER_MANAGEMENT)) || defined(USE_LCD_NOTIFIER)
static ssize_t store_smooth_up_sleep(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
 ...
 */
#ifdef ENABLE_HOTPLUGGING
static ssize_t store_hotplug_sleep(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
 ...
 */
static ssize_t store_freq_limit(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	int i = 0;
 ...
 */
#if (defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) && !defined(DISABLE_POWER_MANAGEMENT)) || defined(USE_LCD_NOTIFIER)
static ssize_t store_freq_limit_sleep(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	int i = 0;
...
static ssize_t store_fast_scaling_up(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
// Yank: tuneable -> possible values 1-4 to enable fast scaling and 5 for auto fast scaling (insane scaling)
static ssize_t store_fast_scaling_down(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
#if (defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) && !defined(DISABLE_POWER_MANAGEMENT)) || defined(USE_LCD_NOTIFIER)
static ssize_t store_fast_scaling_sleep_up(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
// Yank: tuneable -> possible values 1-4 to enable fast scaling and 5 for auto fast scaling (insane scaling) in early suspend
#if (defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) && !defined(DISABLE_POWER_MANAGEMENT)) || defined(USE_LCD_NOTIFIER)
static ssize_t store_fast_scaling_sleep_down(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t store_afs_threshold##name(struct kobject *a, struct kobj_attribute *b,		\
...
static ssize_t store_grad_up_threshold(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
#if (defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) && !defined(DISABLE_POWER_MANAGEMENT)) || defined(USE_LCD_NOTIFIER)
static ssize_t store_grad_up_threshold_sleep(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_early_demand(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
#if (defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) && !defined(DISABLE_POWER_MANAGEMENT)) || defined(USE_LCD_NOTIFIER)
static ssize_t store_early_demand_sleep(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_disable_hotplug(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
#if (defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) && !defined(DISABLE_POWER_MANAGEMENT)) || defined(USE_LCD_NOTIFIER)
static ssize_t store_disable_hotplug_sleep(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_hotplug_block_up_cycles(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_hotplug_block_down_cycles(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_hotplug_stagger_up(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_hotplug_stagger_down(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_hotplug_idle_threshold(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_hotplug_idle_freq(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	int i = 0;
...
static ssize_t store_hotplug_engage_freq(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	int i = 0;
...
static ssize_t store_hotplug_max_limit(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t store_hotplug_lock(struct kobject *a, struct kobj_attribute *b,
 const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t store_hotplug_min_limit(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
// ZZ: tuneable -> possible values: range from 0 (disabled) to policy->max, if not set default is 0 (ffolkes)
static ssize_t store_scaling_responsiveness_freq(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	int i = 0;
...
static ssize_t store_scaling_responsiveness_up_threshold(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
...
static ssize_t store_scaling_block_threshold(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_scaling_block_cycles(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_scaling_up_block_cycles(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_scaling_up_block_freq(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	int i = 0;
...
static ssize_t store_scaling_block_temp(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
#ifdef ENABLE_SNAP_THERMAL_SUPPORT
static ssize_t store_scaling_trip_temp(struct kobject *a, struct kobj_attribute *b,
													const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t store_scaling_block_freq(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	int i = 0;
...
static ssize_t store_scaling_block_force_down(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_scaling_fastdown_freq(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	int i = 0;
...
static ssize_t store_scaling_fastdown_up_threshold(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_scaling_fastdown_down_threshold(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_scaling_proportional(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_inputboost_cycles(struct kobject *a, struct kobj_attribute *b,
									   const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t store_inputboost_up_threshold(struct kobject *a, struct kobj_attribute *b,
											 const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t store_inputboost_punch_cycles(struct kobject *a, struct kobj_attribute *b,
											 const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t store_inputboost_punch_freq(struct kobject *a, struct kobj_attribute *b,
										   const char *buf, size_t count)
{
	unsigned int input;
	unsigned int i;
...
static ssize_t store_inputboost_punch_on_fingerdown(struct kobject *a, struct kobj_attribute *b,
											 const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t store_inputboost_punch_on_fingermove(struct kobject *a, struct kobj_attribute *b,
											  const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t store_inputboost_punch_on_epenmove(struct kobject *a, struct kobj_attribute *b,
												  const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t store_inputboost_typingbooster_up_threshold(struct kobject *a, struct kobj_attribute *b,
											 const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t store_inputboost_typingbooster_cores(struct kobject *a, struct kobj_attribute *b,
														   const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t store_music_max_freq(struct kobject *a, struct kobj_attribute *b,
									const char *buf, size_t count)
{
	unsigned int input;
	unsigned int i;
...
static ssize_t store_music_min_freq(struct kobject *a, struct kobj_attribute *b,
									const char *buf, size_t count)
{
	unsigned int input;
	unsigned int i;
...
static ssize_t store_music_min_cores(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_music_state(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret, i;
	ret = sscanf(buf, "%u", &input);
...
static ssize_t store_profile_sticky_mode(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t store_profile_number(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
...
static ssize_t store_auto_adjust_freq_thresholds(struct kobject *a, struct kobj_attribute *b, const char *buf, size_t count)
{
	unsigned int input;
	int ret;
