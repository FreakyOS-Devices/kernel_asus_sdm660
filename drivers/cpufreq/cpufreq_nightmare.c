...
static ssize_t store_inc_cpu_load_at_min_freq(struct kobject *a, struct kobj_attribute *b,
				   const char *buf, size_t count)
{
	int input;
	int ret;
...
/* inc_cpu_load */
static ssize_t store_inc_cpu_load(struct kobject *a, struct kobj_attribute *b,
					const char *buf, size_t count)
{
	int input;
	int ret;
...
/* dec_cpu_load */
static ssize_t store_dec_cpu_load(struct kobject *a, struct kobj_attribute *b,
					const char *buf, size_t count)
{
	int input;
	int ret;
...
static ssize_t store_freq_for_responsiveness(struct kobject *a, struct kobj_attribute *b,
				   const char *buf, size_t count)
{
	int input;
	int ret;
...
static ssize_t store_freq_for_responsiveness_max(struct kobject *a, struct kobj_attribute *b,
				   const char *buf, size_t count)
{
	int input;
	int ret;
...
static ssize_t store_freq_step_at_min_freq(struct kobject *a, struct kobj_attribute *b,
			       const char *buf, size_t count)
{
	int input;
	int ret;
...
static ssize_t store_freq_up_brake_at_min_freq(struct kobject *a, struct kobj_attribute *b,
				      const char *buf, size_t count)
{
	int input;
	int ret;
...
/* freq_up_brake */
static ssize_t store_freq_up_brake(struct kobject *a, struct kobj_attribute *b,
				      const char *buf, size_t count)
{
	int input;
	int ret;
...
/* freq_step_dec */
static ssize_t store_freq_step_dec(struct kobject *a, struct kobj_attribute *b,
				       const char *buf, size_t count)
{
	int input;
	int ret;
...
static ssize_t store_freq_step_dec_at_max_freq(struct kobject *a, struct kobj_attribute *b,
				       const char *buf, size_t count)
{
	int input;
	int ret;
