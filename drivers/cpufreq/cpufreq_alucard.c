...
static ssize_t store_dec_cpu_load_at_min_freq(struct kobject *a, struct kobj_attribute *b,
				   const char *buf, size_t count)
{
	int input;
	int ret;
...
/* freq_responsiveness */
static ssize_t store_freq_responsiveness(struct kobject *a, struct kobj_attribute *b,
				   const char *buf, size_t count)
{
	int input;
	int ret;
...
/* cpus_up_rate */
static ssize_t store_cpus_up_rate(struct kobject *a, struct kobj_attribute *b,
				   const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
/* cpus_down_rate */
static ssize_t store_cpus_down_rate(struct kobject *a, struct kobj_attribute *b,
				   const char *buf, size_t count)
{
	unsigned int input;
	int ret;
